...
export default class ChatBoard extends Component {
    ...
    render() {
        return (
            <div>
                <Container fluid className="chatCon12">
                    <Col lg={12} md={12} sm={12} className="chatCol12">
                        <div className="viewChatBoard">
                            ...
                            <div className="viewBottom">
                                <Button className="icOpenGallery shadow-none" onClick={() => this.refInput.click()}><i class="fa fa-picture-o"></i></Button>
                                <input
                                    ref={el => {
                                        this.refInput = el
                                    }}
                                ...
                                />
                                <Button className="icOpenSticker shadow-none" onClick={this.openListSticker}><i class="fa fa-tag"></i></Button>
                                ...
                                />
                                <Button className="icSend shadow-none" onClick={() => { this.onSendMessage(this.state.inputValue, 0) }}><i class="fa fa-paper-plane"></i></Button>
                            </div>
